    ...
    <section class="blog about-blog">
        <div class="container">
            ...
            <div class="blog-heading about-heading">
                ...
                <h1 class="heading"><?php  echo "Hey , " .(isset( $_SESSION['username'] ) ?  $_SESSION['username'] : "User Dashboard"); ?></h1>
            </div>
        </div>
    </section>
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="user-profile">
                                <div class="user-title">
                                    <p class="paragraph">Hello, <?php echo $_SESSION['username']; ?></p>
                                                ...
                                                <div class="seller-info">
                                                    ...
                                                    <div class="info-list">
                                                        ...
                                                        <div class="info-details">
                                                            ...
                                                            <p>
                                                                <?php echo (isset($row['address']) ? $row['address'] : ' ')." ".(isset($country['name']) ? $country['name'] :' ')." ". (isset($state['name']) ? $state['name'] :' ')." ". (isset($city['name']) ? $city['name'] :' '); ?>
                                                                </p>
